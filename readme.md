...
* Either
  ...
  * 99.9% required because this gives the launchpads, launchsite, sledgehammer, mobileVAB, and orbitalhangar functions.
    * KSP will load all parts but some will have reduced or no function
    * The configs autodetects if ExtraplanetaryLaunchpads or SimpleConstruction are installed and uses the corresponding modules.
